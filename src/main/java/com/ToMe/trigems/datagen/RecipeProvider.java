...
public class RecipeProvider extends net.minecraft.data.RecipeProvider {
	...
	// Item Tags
	private ITag<Item> gemTopaz = forgeTag("gems/topaz");
	private ITag<Item> blockTopaz = forgeTag("storage_blocks/topaz");
	private ITag<Item> oreTopaz = forgeTag("ores/topaz");
	private ITag<Item> gemRuby = forgeTag("gems/ruby");
	private ITag<Item> blockRuby = forgeTag("storage_blocks/ruby");
	private ITag<Item> oreRuby = forgeTag("ores/ruby");
	private ITag<Item> gemSapphire = forgeTag("gems/sapphire");
	private ITag<Item> blockSapphire = forgeTag("storage_blocks/sapphire");
	private ITag<Item> oreSapphire = forgeTag("ores/sapphire");
	private ITag<Item> gemEmerald = forgeTag("gems/emerald");
	...
	private void smeltingBlastingRecipe(Consumer<IFinishedRecipe> consumer, ITag<Item> input, IItemProvider result,
