...
public class GenerationHelper implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator, IChunkProvider chunkProvider) {
		...
		if((ConfigHandler.oregen_overworld_only && chunkGenerator instanceof ChunkProviderOverworld) || (!ConfigHandler.oregen_overworld_only && !(chunkGenerator instanceof ChunkProviderHell) && !(chunkGenerator instanceof ChunkProviderEnd))) {
