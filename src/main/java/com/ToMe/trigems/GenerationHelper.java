...
public class GenerationHelper implements IWorldGenerator {
	...
	public void generate(Random random, int chunkX, int chunkZ, World world, IChunkGenerator chunkGenerator,
		...
		if ((ConfigHandler.oregen_overworld_only && chunkGenerator instanceof ChunkGeneratorOverworld)
				|| (!ConfigHandler.oregen_overworld_only && !(chunkGenerator instanceof ChunkGeneratorHell)
