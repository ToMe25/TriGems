...
public class TriGemsMod {
	...
	public TriGemsMod() {
		...
		MinecraftForge.EVENT_BUS.addListener(GenerationHelper::onBiomeLoad);
		cfg.Init();
		//loadItems();
		//loadBlocks();
	}
	...
	public static void registerItems(RegistryEvent.Register<Item> e) {
		...
		if(ConfigHandler.enableTopaz) {
			...
			TriGemsMod.topaz = new Item(new Item.Properties().group(ItemGroup.MATERIALS)).setRegistryName(MODID, "topaz");
			...
			//TriGemsMod.TopazHoe = new Hoe("topaz_hoe", ToolTiers.TOPAZ, -3, 0.0F);
			...
			TriGemsMod.TopazHoe = new HoeItem(ToolTiers.TOPAZ, -3, 0.0F, new Item.Properties().group(ItemGroup.TOOLS)).setRegistryName(MODID, "topaz_hoe");
		...
		if(ConfigHandler.enableRuby) {
			...
			TriGemsMod.ruby = new Item(new Item.Properties().group(ItemGroup.MATERIALS)).setRegistryName(new ResourceLocation(MODID, "ruby"));
			...
			//TriGemsMod.RubyHoe = new Hoe("ruby_hoe", ToolTiers.RUBY, -3, 0.0F);
			...
			TriGemsMod.RubyHoe = new HoeItem(ToolTiers.RUBY, -3, 0.0F, new Item.Properties().group(ItemGroup.TOOLS)).setRegistryName(MODID, "ruby_hoe");
		...
		if(ConfigHandler.enableSapphire) {
			...
			TriGemsMod.sapphire = new Item(new Item.Properties().group(ItemGroup.MATERIALS)).setRegistryName(new ResourceLocation(MODID, "sapphire"));
			...
			//TriGemsMod.SapphireHoe = new Hoe("sapphire_hoe", ToolTiers.SAPPHIRE, -3, 0.0F);
			...
			TriGemsMod.SapphireHoe = new HoeItem(ToolTiers.SAPPHIRE, -3, 0.0F, new Item.Properties().group(ItemGroup.TOOLS)).setRegistryName(MODID, "sapphire_hoe");
		...
		if(ConfigHandler.enableEmerald) {
			...
			//TriGemsMod.EmeraldHoe = new Hoe("emerald_hoe", ToolTiers.EMERALD, -3, 0.0F);
			...
			TriGemsMod.EmeraldHoe = new HoeItem(ToolTiers.EMERALD, -3, 0.0F, new Item.Properties().group(ItemGroup.TOOLS)).setRegistryName(MODID, "emerald_hoe");
