	...
	public void preInit(FMLPreInitializationEvent e) {
		...
		if (ConfigHandler.enableTopaz) {
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.blockTopaz),
					new Object[] { "TTT", "TTT", "TTT", 'T', "gemTopaz" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazPickaxe),
					new Object[] { "GGG", " S ", " S ", 'G', "gemTopaz", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazAxe),
					new Object[] { "GG", "GS", " S", 'G', "gemTopaz", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazShovel),
					new Object[] { "G", "S", "S", 'G', "gemTopaz", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazHoe),
					new Object[] { "GG", " S", " S", 'G', "gemTopaz", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazSword),
					new Object[] { "G", "G", "S", 'G', "gemTopaz", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazHelmet),
					new Object[] { "TTT", "T T", 'T', "gemTopaz" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazChest),
					new Object[] { "T T", "TTT", "TTT", 'T', "gemTopaz" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazLegs),
					new Object[] { "TTT", "T T", "T T", 'T', "gemTopaz" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.TopazBoots),
					new Object[] { "T T", "T T", 'T', "gemTopaz" }));
		}
		...
		if (ConfigHandler.enableRuby) {
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.blockRuby),
					new Object[] { "TTT", "TTT", "TTT", 'T', "gemRuby" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyPickaxe),
					new Object[] { "GGG", " S ", " S ", 'G', "gemRuby", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyAxe),
					new Object[] { "GG", "GS", " S", 'G', "gemRuby", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyShovel),
					new Object[] { "G", "S", "S", 'G', "gemRuby", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyHoe),
					new Object[] { "GG", " S", " S", 'G', "gemRuby", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubySword),
					new Object[] { "G", "G", "S", 'G', "gemRuby", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyHelmet),
					new Object[] { "TTT", "T T", 'T', "gemRuby" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyChest),
					new Object[] { "T T", "TTT", "TTT", 'T', "gemRuby" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyLegs),
					new Object[] { "TTT", "T T", "T T", 'T', "gemRuby" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.RubyBoots),
					new Object[] { "T T", "T T", 'T', "gemRuby" }));
		}
		...
		if (ConfigHandler.enableSapphire) {
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.blockSapphire),
					new Object[] { "TTT", "TTT", "TTT", 'T', "gemSapphire" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphirePickaxe),
					new Object[] { "GGG", " S ", " S ", 'G', "gemSapphire", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireAxe),
					new Object[] { "GG", "GS", " S", 'G', "gemSapphire", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireShovel),
					new Object[] { "G", "S", "S", 'G', "gemSapphire", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireHoe),
					new Object[] { "GG", " S", " S", 'G', "gemSapphire", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireSword),
					new Object[] { "G", "G", "S", 'G', "gemSapphire", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireHelmet),
					new Object[] { "TTT", "T T", 'T', "gemSapphire" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireChest),
					new Object[] { "T T", "TTT", "TTT", 'T', "gemSapphire" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireLegs),
					new Object[] { "TTT", "T T", "T T", 'T', "gemSapphire" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.SapphireBoots),
					new Object[] { "T T", "T T", 'T', "gemSapphire" }));
		}
		...
		if (ConfigHandler.enableEmerald) {
			...
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldPickaxe),
					new Object[] { "GGG", " S ", " S ", 'G', "gemEmerald", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldAxe),
					new Object[] { "GG", "GS", " S", 'G', "gemEmerald", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldShovel),
					new Object[] { "G", "S", "S", 'G', "gemEmerald", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldHoe),
					new Object[] { "GG", " S", " S", 'G', "gemEmerald", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldSword),
					new Object[] { "G", "G", "S", 'G', "gemEmerald", 'S', "stickWood" }));
			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldHelmet),
					new Object[] { "TTT", "T T", 'T', "gemEmerald" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldChest),
					new Object[] { "T T", "TTT", "TTT", 'T', "gemEmerald" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldLegs),
					new Object[] { "TTT", "T T", "T T", 'T', "gemEmerald" }));

			GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(TriGemsMod.EmeraldBoots),
					new Object[] { "T T", "T T", 'T', "gemEmerald" }));
		}
	}
