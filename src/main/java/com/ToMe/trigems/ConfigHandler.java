...
public class ConfigHandler {
	...
	public void initConfig() {
		...
		oregen_overworld_only = cfg.getBoolean("oregen_overworld_only", Configuration.CATEGORY_GENERAL, oregen_overworld_only, "if this is set to true ores will only be generated if the chunkGenerator is an instance of \"ChunkProviderOverworld\". if it's set to false ores will be generated if the chunkGenerator isn't a instance of \"ChunkProviderHell\" or \"ChunkProviderEnd\", that means in more Mod dimensions.");
